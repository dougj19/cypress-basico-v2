...
describe('central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatorios e enviar o formulario', function() {
        const testoGrande = 'test, test,test, test,test, test,test, test,test, test,test, test'
        cy.get('#firstName').type('Douglas')
        cy.get('#email').type('douglas@hotmail.com')
        cy.get('#lastName').type('santos')
        cy.get('#open-text-area').type(testoGrande, { delay: 0})
...
it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
    ...
    cy.get('#email').type('douglas@hotmail.com').should('have.value', 'douglas@hotmail.com').clear().should('have.value', '')
